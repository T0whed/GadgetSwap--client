          ...
          <Provider store={reduxStore}>
            <Routes>
              <Route path={"/"} element={<MainLayout></MainLayout>}>
                ...
                <Route
                  path={"/all-gadgets"}
                  element={<AllGadgetsPage></AllGadgetsPage>}
                ></Route>
                <Route
                  path={"/all-gadgets/gadget-details/:id"}
                ...
                >
                  <Route
                    ...
                    element={<UserOverviewPage></UserOverviewPage>}
                  />
                  <Route
                    path={"/dashboard/user/my_rentals"}
                    element={<UserMyRentalsPage></UserMyRentalsPage>}
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={<UserMessagesPage></UserMessagesPage>}
                  />
                  <Route
                    path={"/dashboard/user/loyalty_and_rewards"}
                    element={
                      <UserLoyaltyAndRewardPage></UserLoyaltyAndRewardPage>
                    }
                  />
                  <Route
                  ...
                  <Route
                    path={"/dashboard/admin/total_overview"}
                    element={<AdminTotalOverviewPage></AdminTotalOverviewPage>}
                  />
                  <Route
                    path={"/dashboard/admin/all_users"}
                    element={<AdminAllUsersPage></AdminAllUsersPage>}
                  />
                  <Route
                    path={"/dashboard/admin/all_messages"}
                    element={<AdminAllMessagesPage></AdminAllMessagesPage>}
                  />
                  <Route
                    path={"/dashboard/admin/all_gadgets"}
                    element={<AdminAllGadgetsPage></AdminAllGadgetsPage>}
                  />
                  <Route
                    path={"/dashboard/admin/all_rentals"}
                    element={<AdminAllRentalsPage></AdminAllRentalsPage>}
                  />
                  <Route
                ...
                <Route
                  ...
                  element={<CookieSettingsPage></CookieSettingsPage>}
                ></Route>
                <Route
                  path={"/privacy-policy"}
                ...
                <Route
                  path={"/imprint"}
                  element={<ImprintPage></ImprintPage>}
                ></Route>
              </Route>
