...
const DashboardPage = () => {
  ...
  useEffect(() => {
    if (registeredUser?.email) {
      ...
      dispatch(
        getUserMessagesChain({ userEmail: registeredUser?.email, axiosSecure })
      );
    }
    ...
    const getUserProfileDetailsData = async () => {
      if (userProfileDetails !== null) {
        setUser({
          ...
          avatar:
            userProfileDetails?.personalDetails?.photoURL || defaultAvatar,
  ...
  const AdminLeftSidebarTabs = [
    ...
    },
    {
      id: "all_messages",
      name: "All Messages",
      icon: <FiMessageSquare className="mr-3" size={20} />,
    },
    {
      id: "all_gadgets",
      name: "All Gadgets",
    ...
    },
    {
      id: "all_rentals",
      name: "All Rentals",
      icon: <FiShoppingCart className="mr-3" size={20} />,
    },
    {
      id: "settings",
      name: "Settings",
  ...
  return (
    <div
      className={`min-h-[calc(100vh-421px)] transition-colors duration-300 ${
    ...
    >
      ...
      <div className="flex justify-center items-center">
        {isMobileView && (
          <button
            ...
            className={`mt-20 px-2 py-1 border border-gray-600 rounded-lg ${
              darkMode
      ...
      {isMobileView && isMobileMenuOpen && (
        <div
          className={`mb-6 w-11/12 mx-auto rounded-xl overflow-hidden ${
