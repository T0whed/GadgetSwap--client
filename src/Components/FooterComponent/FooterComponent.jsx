  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className={`absolute -top-24 -right-24 w-52 h-52 rounded-full opacity-15 ${
            darkMode ? "bg-purple-600" : "bg-indigo-700"
          }`}
        ></div>
        <div
        ...
        ></div>
        <div
          className={`absolute -bottom-32 right-1/4 w-80 h-80 rounded-full opacity-15 ${
      ...
      <div className="container mx-auto px-4 pt-20 pb-5 relative z-10">
        ...
        {/* Divider */}
        <div
          className={`h-px w-full ${darkMode ? "bg-gray-800" : "bg-gray-200"}`}
        ></div>
            ...
            <button
              ...
              className={`mt-4 md:mt-0 p-3 rounded-full transition-all duration-300 transform hover:scale-110 ${
                darkMode
                  ...
                  : "bg-white text-indigo-600 hover:bg-gray-200 shadow-sm"
              }`}
