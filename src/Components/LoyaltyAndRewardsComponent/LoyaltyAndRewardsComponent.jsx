...
const LoyaltyAndRewardsComponent = () => {
  ...
  const loyaltyTiers = [
    {
      ...
      benefits: [
        {
          id: "b1",
          text: "Access to basic gadget catalog",
          icon: <FiGift size={16} />,
        },
        {
          id: "b2",
          text: "Standard delivery options",
          icon: <FiTruck size={16} />,
        },
        {
          id: "b3",
          text: "5% discount on extended rentals",
    ...
    },
    {
      ...
      benefits: [
        ...
        {
          id: "s3",
          text: "10% discount on extended rentals",
          icon: <FiPercent size={16} />,
        },
        {
          id: "s4",
        ...
        {
          id: "s5",
          text: "Access to premium gadget catalog",
          icon: <FiStar size={16} />,
        },
      ],
    },
    {
      ...
      benefits: [
        ...
        {
          id: "g2",
          text: "15% discount on extended rentals",
          icon: <FiPercent size={16} />,
        },
        {
          id: "g3",
        ...
        {
          id: "g4",
          text: "Priority access to new gadgets",
        ...
        {
          id: "g6",
          text: "Free basic insurance on rentals",
    ...
    },
    {
      ...
      benefits: [
        ...
        {
          id: "p2",
          text: "25% discount on extended rentals",
          icon: <FiPercent size={16} />,
        },
        {
          id: "p3",
          text: "Free premium insurance on all rentals",
          icon: <FiShield size={16} />,
        },
        {
          id: "p4",
          text: "Free overnight shipping",
          icon: <FiTruck size={16} />,
        },
        { id: "p5", text: "VIP customer support", icon: <FiHeart size={16} /> },
        {
          id: "p6",
          text: "Early access to limited edition gadgets",
          icon: <FiStar size={16} />,
        },
        {
          id: "p7",
          text: "Exclusive member events and workshops",
  ...
  const rewardsData = [
    {
      ...
      description:
        "Redeem points for discounts on your next gadget rental. The more points you use, the bigger the discount!",
      redemptionOptions: [
    ...
    },
    {
      ...
      description:
        "Use your points to extend your current rental period without additional charges.",
      redemptionOptions: [
    ...
    },
    {
      ...
      description:
        "Upgrade your rental to a premium model or add premium accessories to your existing rental.",
      redemptionOptions: [
    ...
    },
    {
      ...
      description:
        "Redeem points for insurance coverage on your rentals for peace of mind.",
      redemptionOptions: [
    ...
    },
    {
      ...
      description:
        "Use points to gain early or exclusive access to limited edition and high-demand gadgets.",
      redemptionOptions: [
    ...
    },
    {
      ...
      description:
        "Convert your loyalty points into gift cards for popular retailers and online stores.",
      redemptionOptions: [
  ...
  const earnPointsData = [
    ...
    },
    {
      ...
      description:
        "Earn 500 points when a referred friend completes their first rental",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            ...
            discounts, and premium experiences
          </p>
        </div>
            ...
            {loyaltyTiers.map((tier) => (
              ...
              >
                ...
                >
                  {/* Tier Header */}
                  <div
                    className={`bg-gradient-to-r ${tier.color} p-6 md:p-8 text-white`}
                  >
              ...
              <div className="p-6 md:p-8">
                <div className="flex flex-col md:flex-row justify-between items-center">
                  <div className="mb-4 md:mb-0">
                    ...
                    >
                      Sign in to view your current points balance and redeem
                      rewards
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <div
                      className={`mt-4 pt-4 text-sm ${
                        darkMode
                          ? "border-t border-purple-800/80"
                          : "border-t border-indigo-300/50"
                      }`}
                    >
        ...
        <div className="w-10/12 mx-auto mt-16">
          ...
          >
            <div
              className={`divide-y ${
                darkMode ? "divide-gray-700/80" : "divide-gray-700/20"
              }`}
            >
              <div
              ...
              >
                ...
                {activeIndex === 0 && (
                  <p className={darkMode ? "text-gray-300" : "text-gray-600"}>
                    You earn 10 points for every $1 spent on rentals. Additional
                    points can be earned by writing reviews, referring friends,
                    and maintaining a rental streak.
                  </p>
                )}
              </div>
              ...
              >
                ...
                {activeIndex === 1 && (
                  <p className={darkMode ? "text-gray-300" : "text-gray-600"}>
                    ...
                    earned. Any activity on your account will extend all your
                    points for another 12 months.
                  </p>
                )}
              </div>
              ...
              >
                ...
                {activeIndex === 2 && (
                  <p className={darkMode ? "text-gray-300" : "text-gray-600"}>
                    You can redeem your points through your account dashboard.
                    Select the reward you want to redeem and follow the
                    instructions. Points will be deducted automatically.
                  </p>
                )}
              </div>
              ...
              >
                ...
                {activeIndex === 3 && (
                  <p className={darkMode ? "text-gray-300" : "text-gray-600"}>
                    Membership tiers are automatically upgraded when you reach
                    the required points threshold. Silver requires 500 points,
                    Gold requires 1,500 points, and Platinum requires 5,000
                    points.
                  </p>
                )}
              </div>
