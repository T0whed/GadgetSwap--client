    ...
    >
      ...
      <main className="container mx-auto px-4 py-16 pt-32">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            Please read our terms carefully to understand your rights and
            responsibilities.
          </p>
        </div>
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  ...
                  >
                    By using GadgetSwap, you acknowledge that you have read,
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  ...
                  >
                    These Terms and Conditions may be updated periodically. It
                    is your responsibility to check for updates. Continued use
                    of GadgetSwap after changes constitutes acceptance of the
                    modified terms.
                  </p>
                </div>
              </div>
