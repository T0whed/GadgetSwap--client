...
const GadgetDetailsComponent = () => {
  ...
  const handlePrevImage = () => {
    ...
    setSelectedImage((prev) =>
      prev === 0 ? gadget.images.length - 1 : prev - 1
    );
  };
  ...
  const handleNextImage = () => {
    if (!gadget || !gadget.images || gadget.images.length === 0) return;
    setSelectedImage((prev) =>
      prev === gadget.images.length - 1 ? 0 : prev + 1
    );
  };
  ...
  const getBlockedDates = (blockedDates, totalCopy) => {
    ...
    return Object.keys(dateCounts).filter(
      (date) => dateCounts[date] >= totalCopy
    );
  };
  ...
  const handleRentNowClick = async () => {
    ...
    if (userProfileDetails?.personalDetails?.verified === false) {
      toast.error(
        "Please complete your profile, get verified to rent this gadget!"
      );
    ...
    await navigate(
      `/selected-gadget/rental_order/${newRentalOrderObj?.order_id}/payment`,
      { state: { newRentalOrderObj } }
    );
  };
  ...
  // Get average rating
  const averageRating =
    gadget.average_rating || getAverageRating(gadget.ratings);

  return (
    <div
      className={`min-h-[calc(100vh-421px)] pt-16 transition-colors duration-300 ${
          ...
          <div className="flex items-center space-x-2">
            {registeredUser && userProfileDetails?.role === "user" && (
              <button
                ...
                aria-label={
                  userProfileDetails?.wishlist?.includes(id)
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm mt-1">
                <span className="font-medium">{gadget?.brand}</span> • Model:{" "}
                {gadget?.model}
              </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                    ...
                    >
                      ...
                      >
                        Basic coverage against accidental damage included.
              ...
              {activeTab === "specs" && (
                <div className="space-y-6">
                  <div>
                    ...
                    >
                      {Object.entries(gadget?.specifications || {}).map(
                        ([key, value], index, arr) => (
                          <div
                            key={key}
                          ...
                          >
                            <span
                              className={`w-1/3 font-medium capitalize ${
                                darkMode ? "text-gray-300" : "text-gray-700"
                              }`}
                            >
                              {key}
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        >
                          Please handle with care. Any damage beyond normal wear
                          and tear may incur additional charges.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {(!gadget?.reviews || gadget.reviews.length === 0) && (
                      ...
                      >
                        <p className="text-sm">
                          No reviews yet. Be the first to review this gadget!
                        </p>
                      </div>
                    )}
                  </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          >
                            <div className="flex justify-between items-center mb-1">
                              ...
                              <span className="text-sm font-bold">
                                $
                                {gadget?.pricing?.basicInsuranceFee?.toFixed(2)}
                                /day
                              </span>
                            </div>
                          ...
                          >
                            <div className="flex justify-between items-center mb-1">
                              ...
                              <span className="text-sm font-bold">
                                $
                                {gadget?.pricing?.premiumInsuranceFee?.toFixed(
                                  2
                                )}
                                /day
                              </span>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border-t border-gray-200 dark:border-gray-600 my-2 pt-2 flex justify-between">
                          ...
                          <span className="font-bold">
                            $
                            {(
                              Number.parseFloat(priceDetails.total) + 5
                            ).toFixed(2)}
                          </span>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    {(() => {
                      ...
                      return fullyBookedDates.length > 0 ? (
                        ...
                        >
                          No unavailable dates. This gadget has available
                          copies.
                        </p>
                      );
                    })()}
