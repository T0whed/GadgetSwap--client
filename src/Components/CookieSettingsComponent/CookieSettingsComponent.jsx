...
const CookieSettingsComponent = () => {
  ...
  const [cookieSettings, setCookieSettings] = useState({
    ...
    functional: {
      ...
      cookies: [
        ...
        },
        {
          ...
          purpose: "Tracks recently viewed gadgets",
          duration: "30 days",
        },
      ],
    },
    ...
    marketing: {
      ...
      description:
        "These cookies are used to track visitors across websites. They are set to display targeted advertisements that are relevant and engaging for individual users, and thereby more valuable for publishers and third-party advertisers.",
      cookies: [
        {
          name: "_fbp",
          purpose: "Facebook Pixel - Identifies browsers for ad targeting",
          duration: "3 months",
        },
        {
          name: "ads_id",
          purpose: "Tracks conversion from ads",
          duration: "30 days",
        },
        {
          name: "recommendation_id",
          purpose: "Powers product recommendations",
          duration: "30 days",
        },
      ],
    },
    ...
    >
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  >
                    We use cookies to enhance your experience. Please select
      ...
      <main className="container mx-auto px-4 py-16 pt-32">
        ...
        <div className="max-w-4xl mx-auto">
          {/* Introduction */}
          <div
            className={`p-6 rounded-xl mb-8 transition-colors ${
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                >
                  ...
                  help the website provide a better user experience. In general,
                  cookies are used to retain user preferences, store information
                  for things like shopping carts, and provide anonymized
                ...
                >
                  ...
                  others. The most effective way to do this is to disable
                  cookies in your browser. We suggest consulting the Help
                  section of your browser or taking a look at the{" "}
                  <a
                    href="#"
                    className={`${
                      darkMode
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {cookieSettings[key]?.cookies.map(
                              (cookie, index) => (
                                <tr key={index}>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p
                  className={`${darkMode ? "text-gray-300" : "text-gray-700"}`}
                >
                  GadgetSwap is committed to protecting your privacy. We use
                  cookies responsibly and in accordance with our Privacy Policy.
                  Your cookie preferences will be remembered for 6 months, after
                  which you'll be asked to confirm them again.
                </p>
                <p
                  className={`mt-4 ${
                    darkMode ? "text-gray-300" : "text-gray-700"
