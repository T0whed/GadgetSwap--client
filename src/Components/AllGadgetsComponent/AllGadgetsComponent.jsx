...
const AllGadgetsComponent = () => {
  ...
  const categories = [
    ...
    {
      name: "Headphones",
      icon: <FaHeadphones className="mr-2 text-cyan-500" />,
    },
  ...
  return (
    <div
      className={`min-h-screen py-8 pt-32 transition-colors duration-300 ${
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            Discover the latest tech available for rent from the best gadget
            brands.
          </p>
        </div>
        ...
        >
          ...
          {isFilterMenuOpen && (
            <div
              className={`mt-4 p-4 rounded-lg lg:hidden transition-colors ${
                darkMode ? "bg-gray-700" : "bg-gray-100"
              }`}
            >
        ...
        {!isLoading && !isFiltering && currentGadgets.length === 0 && (
          <div
            className={`text-center py-16 transition-colors ${
              darkMode ? "text-gray-300" : "text-gray-600"
            }`}
          >
              ...
              : currentGadgets.map((gadget) => (
                  ...
                  >
                    ...
                    <div className="p-4 flex flex-col h-44">
                      ...
                      <p
                        className={`grow text-sm mb-3 line-clamp-2 ${
                          darkMode ? "text-gray-300" : "text-gray-600"
                        }`}
                      >
                        {gadget.description}
                  ...
                  >
                    <div className="flex flex-col sm:flex-row">
                      ...
                      <div className="sm:w-3/4 p-4 sm:p-6 flex flex-col justify-around">
                        <div>
                          <h3
                            className={`text-xl font-medium mb-2 line-clamp-2 transition-colors ${
                              darkMode ? "text-white" : "text-gray-900"
                            }`}
                          >
                            {gadget.name}
