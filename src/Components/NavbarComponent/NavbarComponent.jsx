...
const NavbarComponent = () => {
  ...
  const handleDashboardClick = async () => {
    navigate(
      `${
        user.role === "admin"
          ? "/dashboard/admin/total_overview"
      ...
      <div className="container mx-auto py-3">
        <div className="flex justify-between items-center">
          ...
          <a href="/" onClick={scrollToTop} className="flex items-center group">
            <span
              className={`text-4xl px-2 py-1 font-bold bg-clip-text text-transparent bg-gradient-to-r ${
                darkMode
          ...
          <div className="hidden xl:flex items-center space-x-6">
                ...
                (button) =>
                  ...
                  (button.isScroll ? (
                    <a
                      ...
                      href={button.path}
                      onClick={
                        button.scrollToTop ? scrollToTop : scrollToHowItWorks
                      }
            ...
            >
              {darkMode ? (
                <FiSun size={18} className="animate-pulse" />
              ) : (
                <FiMoon size={18} />
              )}
            </button>
        ...
        {isMenuOpen && (
          <div
            className={`xl:hidden w-11/12 mx-auto mt-3 py-3 px-2 rounded-lg transition-all duration-300 ${
              darkMode
