...
const WhatOurCustomersSayComponent = () => {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      review:
        "GadgetSwap has completely changed how I approach tech. Instead of spending thousands on the latest MacBook Pro, I rented it for a crucial project. The device arrived in pristine condition, and the return process was effortless. I'm now a regular customer!",
    ...
    },
    {
      ...
      rating: 5,
      review:
        "As a content creator, I need different cameras for different projects. GadgetSwap lets me access high-end equipment without the massive investment. Their Sony Alpha A7 IV was delivered on time and in perfect condition. The customer service is exceptional!",
    ...
    },
    {
      ...
      rating: 4,
      review:
        "I wanted to try the PS5 before committing to a purchase. GadgetSwap made it possible with their affordable rental options. The console was in great condition with all accessories included. Only giving 4 stars because delivery was a day late, but everything else was perfect.",
    ...
    },
    {
      ...
      rating: 5,
      review:
        "I needed a powerful laptop for rendering 3D models while traveling. GadgetSwap's Razer Blade 17 was the perfect solution. The performance was outstanding, and the rental process was seamless from start to finish. Will definitely use again for future projects!",
    ...
    },
    {
      ...
      rating: 5,
      review:
        "GadgetSwap has been a game-changer for my photography business. I rented the Canon EOS R5 for a wedding shoot, and the results were spectacular. The equipment was in pristine condition, and the rental cost was a fraction of the purchase price. Highly recommended!",
  ...
  `}
          >
            Discover why tech enthusiasts trust GadgetSwap for their rental
            needs.
          </p>
        </div>
        ...
        >
          ...
          <div
            className={`px-5 relative rounded-2xl overflow-hidden transition-all duration-500 ${
              darkMode
          ...
          >
            ...
            {/* Quote Icon */}
            <div
              className={`absolute top-6 right-6 w-20 h-20 opacity-10 ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 md:p-8">
              ...
              <div className="flex flex-col items-center md:items-start">
                <div className="relative mb-4">
                  ...
                  >
                    <IoThumbsUpOutline
                      className={darkMode ? "text-cyan-400" : "text-indigo-600"}
                      size={16}
                    />
                  </div>
                </div>
              ...
              <div className="md:col-span-2 flex flex-col justify-between">
                <div>
                  <div
                    className={`text-sm md:text-base leading-relaxed mt-20 mb-8 text-justify ${
                      darkMode ? "text-gray-300" : "text-gray-700"
                    }`}
                  >
