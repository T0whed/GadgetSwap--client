...
const ContactUsComponent = () => {
    ...
    social: [
      {
        name: "Facebook",
        icon: <FaFacebook />,
        url: "https://facebook.com/gadgetswap",
      },
      {
        name: "Twitter",
        icon: <FaTwitter />,
        url: "https://twitter.com/gadgetswap",
      },
      {
        name: "Instagram",
        icon: <FaInstagram />,
        url: "https://instagram.com/gadgetswap",
      },
      {
        name: "LinkedIn",
        icon: <FaLinkedin />,
        url: "https://linkedin.com/company/gadgetswap",
      },
    ],
  };
  ...
  const faqData = [
    {
      ...
      answer:
        "Returning is easy! Each rental comes with a prepaid return shipping label. Simply pack the gadget in its original packaging, attach the provided return label, and drop it off at any authorized shipping location.",
    },
    {
      question: "What happens if I damage a rented gadget?",
      answer:
        "All rentals come with basic protection against manufacturing defects. For accidental damage, you may be responsible for repair or replacement costs. We offer optional insurance plans at checkout that cover accidental damage.",
    },
    {
      question: "Can I extend my rental period?",
      answer:
        'Yes, you can extend your rental period through your account dashboard. Go to "My Rentals" and select the item you wish to extend. Choose your new return date and pay for the additional rental period.',
    },
    {
      question: "How does the loyalty program work?",
      answer:
        "Our loyalty program rewards you for every rental. You earn 10 points for every $1 spent on rentals. Additional points can be earned by writing reviews, referring friends, and maintaining a rental streak.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            ...
            anything related to GadgetSwap.
          </p>
        </div>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      >
                        <a
                          href={`tel:${contactInfo.phone.main.replace(
                            /\D/g,
                            ""
                          )}`}
                      ...
                      <p className={darkMode ? "text-white" : "text-gray-900"}>
                        <a
                          href={`tel:${contactInfo.phone.support.replace(
                            /\D/g,
                            ""
                          )}`}
                          className="hover:underline"
                      ...
                      <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-6">
                          ...
                          <div className="relative">
                            ...
                            />
                            {errors.message && (
                              <div className="absolute bottom-3 right-3 flex items-center pr-3 pointer-events-none">
                                <FiAlertCircle className="text-red-500" />
                              </div>
                            )}
                          </div>
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          >
                            Our support team is available for live chat during
                            business hours.
                          </p>
                          <button
                            onClick={toggleChat}
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          >
                            ...
                            district, easily accessible by public
                            transportation.
                          </p>
      ...
      {isChatOpen && (
        <div
          className={`fixed bottom-6 right-6 z-50 w-80 md:w-96 rounded-xl overflow-hidden shadow-2xl ${
            darkMode
              ? "bg-gray-800 border border-gray-700"
              : "bg-white border border-gray-200"
          }`}
