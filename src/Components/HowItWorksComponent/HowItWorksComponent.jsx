  ...
  const steps = [
    {
      ...
      title: "Browse",
      description:
        "Explore our vast collection of premium gadgets using advanced filters to find exactly what you need.",
      icon: <FiSearch size={32} />,
      color: "from-blue-500 to-cyan-500",
      benefit: "Access to the latest tech without commitment",
      highlightEmoji: <IoSparkles className="text-blue-400" size={18} />,
      image:
        "https://res.cloudinary.com/dxh2iyxjs/image/upload/v1742167244/browse_dxfgtc.jpg",
    ...
    },
    {
      ...
      title: "Choose",
      description:
        "Compare specs, read reviews, and select the perfect gadget with flexible rental periods that suit your needs.",
    ...
    },
    {
      ...
      title: "Confirm Rent",
      description:
        "Book your gadget with our secure, hassle-free payment system. Add optional insurance for complete peace of mind.",
      icon: <FiCalendar size={32} />,
      color: "from-violet-500 to-indigo-500",
      benefit: "Transparent pricing with no hidden fees",
      highlightEmoji: (
        <IoShieldCheckmark className="text-violet-400" size={18} />
      ),
      image:
        "https://res.cloudinary.com/dxh2iyxjs/image/upload/v1742167444/confirm_rent_hyb7mg.jpg",
    ...
    },
    {
      ...
      title: "Receive",
      description:
        "Get your gadget delivered to your doorstep with premium packaging, fully charged and ready to use immediately.",
      icon: <FiPackage size={32} />,
      color: "from-purple-500 to-violet-500",
      benefit: "Fast shipping with real-time tracking",
      highlightEmoji: <IoRocket className="text-purple-400" size={18} />,
      image:
        "https://res.cloudinary.com/dxh2iyxjs/image/upload/v1742167654/receive_hgh1yn.jpg",
    ...
    },
    {
      ...
      title: "Use",
      description:
        "Enjoy your premium gadget with full technical support throughout your rental period for any questions or issues.",
    ...
    },
    {
      ...
      title: "Return",
      description:
        "When your rental period ends, simply schedule a pickup. No need to repackage or worry about shipping labels.",
      ...
      image:
        "https://res.cloudinary.com/dxh2iyxjs/image/upload/v1742168286/return_hnyvhi.jpg",
    ...
    },
    {
      ...
      title: "Reward",
      description:
        "Earn loyalty points with every rental that can be redeemed for discounts, extended rental periods, or premium gadgets.",
      icon: <FiAward size={32} />,
      color: "from-amber-500 to-rose-500",
      benefit: "Loyalty program with exclusive member benefits",
      highlightEmoji: <IoRocket className="text-amber-400" size={18} />,
      image:
        "https://res.cloudinary.com/dxh2iyxjs/image/upload/v1742166942/reward_ansntv.jpg",
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          >
            Our streamlined process makes renting high-tech gadgets easier than
            ever. Follow these steps to elevate your tech experience without the
            commitment.
          </p>
        </div>
          ...
          >
            ...
            <div className="relative p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                ...
                <div
                  className={`relative rounded-2xl overflow-hidden h-48 md:h-64 max-w-full mx-auto ${
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-2xl overflow-hidden hologram-effect">
                    ...
                    {/* Corner Markers */}
                    <div className="absolute top-0 left-0 w-6 h-6 md:w-8 md:h-8 border-t-2 border-l-2 border-cyan-400/70 rounded-tl-2xl"></div>
                    <div className="absolute top-0 right-0 w-6 h-6 md:w-8 md:h-8 border-t-2 border-r-2 border-cyan-400/70 rounded-tr-2xl"></div>
                    <div className="absolute bottom-0 left-0 w-6 h-6 md:w-8 md:h-8 border-b-2 border-l-2 border-cyan-400/70 rounded-bl-2xl"></div>
                    <div className="absolute bottom-0 right-0 w-6 h-6 md:w-8 md:h-8 border-b-2 border-r-2 border-cyan-400/70 rounded-br-2xl"></div>
                  </div>
                    ...
                    >
                      ...
                      <div
                        className={`w-4 h-4 md:w-6 md:h-6 rounded-full transition-all duration-300 ${
                          ...
                          index === activeStep
                            ? "scale-150 shadow-lg shadow-cyan-500/30"
                            : "scale-100"
                        }`}
                      >
                        {/* Pulse Effect for Active Step */}
                        {index === activeStep && (
                          <div className="absolute inset-0 rounded-full animate-ping-slow bg-cyan-500 opacity-30"></div>
                        )}
                      </div>
        ...
        <div className="md:hidden">
          <div
            className={`rounded-2xl overflow-hidden backdrop-blur-md p-6 ${
              darkMode
                ...
                >
                  ...
                  <div className="flex items-center mb-3">
                    ...
                    >
                      {/* Glowing Effect */}
                      <div
                        className={`absolute inset-0 rounded-xl bg-gradient-to-br ${step.color} opacity-10 blur-md`}
                      ></div>
        ...
        {/* Call to Action */}
        <div
          className={`mt-12 p-6 md:p-8 rounded-2xl text-center max-w-3xl mx-auto relative overflow-hidden ${
            darkMode
        ...
        >
          ...
          <p className={`mb-6 ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
            Join thousands of tech enthusiasts who are already enjoying premium
            gadgets without the long-term commitment.
          </p>
