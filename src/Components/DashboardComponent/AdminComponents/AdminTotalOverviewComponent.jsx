...
const AdminTotalOverviewComponent = () => {
  ...
  const totalPercentage = dashboardData.rentalsByCategory.reduce(
  ...
  const getCurrentRangeData = () => {
    return dateRange === "week"
      ? dashboardData.earnings.weekly
      : dashboardData.earnings.monthly;
  };
  ...
  return (
    <div
      className={`w-full max-w-7xl mx-auto transition-colors ${
    ...
    >
          ...
          <div className="mt-4 md:mt-0 flex items-center">
            <div className="mr-4">
              ...
              <p className="text-sm font-medium">
                {formatDate(dashboardData.admin.lastLogin)}
              </p>
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div
          className={`rounded-xl p-6 transition-colors cursor-pointer hover:scale-[1.02] transition-transform ${
            darkMode ? "bg-gray-800" : "bg-white shadow-sm"
          }`}
        >
        ...
        >
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl font-bold mt-1">
                {dashboardData.stats.totalGadgets}
              </h3>
            </div>
            <div
              className={`p-3 rounded-lg ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        ...
        <div
          className={`lg:col-span-2 rounded-xl p-6 transition-colors ${
            darkMode ? "bg-gray-800" : "bg-white shadow-sm"
          }`}
        >
      ...
      <div
        className={`rounded-xl transition-colors mb-8 ${
          darkMode ? "bg-gray-800" : "bg-white shadow-sm"
        }`}
      >
