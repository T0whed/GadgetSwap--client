...
const AdminSettingsComponent = () => {
  ...
  return (
    <div
      className={`w-full max-w-7xl mx-auto rounded-xl transition-colors ${
    ...
    >
      ...
      <div className="p-6 pb-0 flex flex-wrap gap-2">
        ...
        <button
          ...
          className={getTabClass("professional")}
        >
          <div className="flex items-center">
        ...
        <button
          ...
          className={getTabClass("membership")}
        >
          <div className="flex items-center">
      ...
      <div className="p-6">
          ...
          >
            ...
            <div className="mt-8 pt-6 border-t border-gray-600">
              ...
              >
                ...
                <p className="mt-2 text-sm text-purple-500 cursor-pointer hover:underline">
        ...
        {activeTab === "membership" && (
          ...
          >
            ...
            <div
              className={`p-6 rounded-xl border-2 border-yellow-500 ${
                darkMode ? "bg-gray-800" : "bg-white"
              }`}
            >
              <div className="flex items-center justify-between">
                ...
                <div className="bg-yellow-500 text-gray-900 px-3 py-1 rounded-full font-bold">
                  ACTIVE
                </div>
              </div>
              ...
              <div className="mt-6 p-4 rounded-lg bg-purple-100 text-purple-800">
                <p className="font-medium">
                  As an admin, your Platinum membership is complimentary and
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={getToggleSwitchClass(
                          adminData.notificationPreferences.email
                        )}
                        onClick={() => handleNotificationToggle("email")}
                      >
                        <span
                          className={getToggleSwitchButtonClass(
                            adminData.notificationPreferences.email
                          )}
                        />
                      </button>
