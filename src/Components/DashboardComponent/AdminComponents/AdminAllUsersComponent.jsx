...
const AdminAllUsersComponent = () => {
  ...
  const fakeUsers = [
    ...
    },
    {
      ...
      role: "user",
      status: "active",
      lastLogin: "2023-08-06T15:30:00",
      registeredDate: "2023-03-30",
  ...
  const userStats = {
    ...
    inactiveUsers: fakeUsers.filter((user) => user.status === "inactive")
      .length,
    suspendedUsers: fakeUsers.filter((user) => user.status === "suspended")
      .length,
  ...
  return (
    <div
      className={`w-full max-w-7xl mx-auto pb-8 rounded-xl ${
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        <div
          className={`rounded-lg p-4 ${
            darkMode ? "bg-gray-800" : "border border-gray-200 bg-gray-50"
          } shadow-sm`}
        >
                          ...
                          <div>
                            ...
                            >
                              ...
                              <div className="flex items-center">
                                ...
                                <span>
                                  Last Login: {formatDate(user.lastLogin)} at{" "}
                                  {formatTime(user.lastLogin)}
                                </span>
                              </div>
                              <div className="flex items-center">
                          ...
                          <div>
                            ...
                            >
                              ...
                              <div className="flex mt-2 space-x-2">
                                ...
                                <button
                                  onClick={() =>
                                    handleUserAction(user.id, "view-rentals")
                                  }
