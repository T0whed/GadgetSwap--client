...
import {
  ...
  getWishlistGadgetsDetails,
} from "../../../Features/gadgetWishlist/gadgetWishlistSlice.js";
...
const UserWishlistComponent = () => {
  ...
  const { wishlistGadgetDetails } = useSelector(
    (state) => state.gadgetWishlist
  );
    ...
    >
      ...
      {wishlistGadgetDetails?.length > 0 ? (
        ...
        >
          ...
          >
            Browse our collection and add gadgets you're interested in renting
            to your wishlist for easy access later.
          </p>
          <button
