...
const UserOverviewComponent = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    notifications: [
      ...
      },
      {
        ...
        type: "loyalty",
        message:
          "Congratulations! You've earned 150 points from your recent rental",
        time: "Yesterday",
        isRead: true,
      },
      {
  ...
  const unreadNotificationsCount = userData.notifications.filter(
    (notif) => !notif.isRead
  ).length;
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="text-2xl font-bold">
                {userData.stats.wishlistedItems}
              </div>
              <div
                className={`text-xs ${
                  darkMode ? "text-gray-400" : "text-gray-500"
              ...
              {userData.wishlist.length > 0 ? (
                userData.wishlist.map((item) => (
                  <div
                    ...
                    onClick={() =>
                      navigateTo(`/all-gadgets/gadget-details/${item.id}`)
                    }
                  >
          ...
          >
            <div className="p-4 text-center">
              ...
              <div className="mt-4 flex items-center justify-center gap-2">
                <FiAward
                  className={`${getMembershipColor(userData.membershipTier)}`}
                  size={18}
                />
              ...
              <div className="mt-4">
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span
                    className={darkMode ? "text-gray-400" : "text-gray-500"}
                  >
                    {userData.pointsToNextTier.toLocaleString()} to{" "}
                    {userData.nextTier}
                  </span>
                </div>
                <div
