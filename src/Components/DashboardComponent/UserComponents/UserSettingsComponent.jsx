          ...
          <div className="p-6">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div
                ...
                className={`relative w-40 h-40 rounded-full overflow-hidden mx-auto md:mx-0 border-2 ${
                ...
                {imagePreview && (
                  ...
                  >
                    ...
                    <p className="mt-2 text-xs">
                      Drag to reposition image. Use zoom buttons to adjust size.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <input
                    ...
                    className={`block w-full px-3 py-2 rounded-r-lg focus:outline-none ${
                      darkMode
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows="4"
                  className={`block w-full px-4 py-3 rounded-lg border focus:outline-none ${
                    darkMode
                ...
                >
                  Brief description about yourself that will be visible on your
                  profile.
                </p>
              </div>
            </div>
