      ...
      <main className="container mx-auto px-4 py-16 pt-32">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="hidden lg:block w-64 flex-shrink-0">
            <div
              className={`sticky top-24 rounded-xl p-4 transition-colors ${
          ...
          <div className="flex-1">
            ...
            >
              ...
              <div className="mb-8">
                ...
                >
                  This Privacy Policy explains how GadgetSwap collects, uses,
                  and protects your personal information when you use our
                  website, mobile applications, and services. By using
                  GadgetSwap, you consent to the data practices described in
                  this policy.
                </p>
              </div>
            ...
            {/* Commitment Section */}
            <div
              className={`mt-8 p-6 rounded-xl transition-colors ${
                darkMode ? "bg-gray-800" : "bg-white shadow-sm"
              }`}
            >
              <div className="flex items-start">
                ...
                <div>
                  ...
                  >
                    At GadgetSwap, we believe in transparency and respect for
                    your privacy. We continuously review and improve our privacy
                    practices to ensure the highest standards of data
                    protection. If you have any questions or concerns about this
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  >
                    ...
                    regarding your personal data. We respect these rights and
                    provide mechanisms for you to exercise them. For more
                    information, please refer to the User Rights section of this
                    policy or contact our Data Protection Officer.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  ...
                  >
                    This Privacy Policy may be updated periodically. It is your
                    responsibility to check for updates. Continued use of
                    GadgetSwap after changes constitutes acceptance of the
                    modified policy.
                  </p>
                </div>
              </div>
