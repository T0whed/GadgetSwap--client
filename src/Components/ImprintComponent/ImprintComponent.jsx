          ...
          <div className="flex-1">
            ...
            >
              ...
              <div className="mb-8">
                ...
                >
                  The following information is provided in accordance with legal
                  requirements for business entities operating online platforms.
                  This imprint applies to the website gadgetswap.com and all its
                  subdomains.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  >
                    ...
                    <br />
                    <a
                      href="mailto:info@gadgetswap.com"
                      className={`${
                        darkMode
                  ...
                  >
                    ...
                    <br />
                    <a
                      href="mailto:legal@gadgetswap.com"
                      className={`${
                        darkMode
                          ? "text-blue-400 hover:text-blue-300"
                          : "text-blue-600 hover:text-blue-700"
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  ...
                  >
                    This imprint complies with the legal requirements of the
                    United States and, where applicable, with EU regulations
                    including but not limited to the German Telemedia Act (TMG)
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  ...
                  >
                    GadgetSwap operates internationally. For country-specific
                    legal information, please contact our legal department at
                    legal@gadgetswap.com.
                  </p>
                </div>
              </div>
